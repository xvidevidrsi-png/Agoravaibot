...
def db_set_config(k, v):
    conn = get_connection()
    cur = execute_query(conn, "INSERT OR REPLACE INTO config (k,v) VALUES (?,?)", (k, v))
    conn.commit()
    conn.close()
...
class FilaCog(commands.Cog):
    ...
    async def criar_filas_1v1(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message("⏳ Criando filas, aguarde...", ephemeral=True)
        ...
        await interaction.edit_original_response(content="✅ Filas 1x1 Mobile criadas!")
    ...
    async def criar_filas_1x1_emu(self, interaction: discord.Interaction):
        ...
        for valor in VALORES_FILAS_1V1:
            ...
            conn.commit()
            conn.close()
        await interaction.edit_original_response(content="✅ Filas 1x1 Emulador criadas!")
    ...
    async def criar_filas_2x2_emu(self, interaction: discord.Interaction):
        ...
        for valor in VALORES_FILAS_1V1:
            ...
            conn.commit()
            conn.close()
        await interaction.edit_original_response(content="✅ Filas 2x2 Emulador criadas!")
    ...
    async def criar_filas_3x3_emu(self, interaction: discord.Interaction):
        ...
        for valor in VALORES_FILAS_1V1:
            ...
            conn.commit()
            conn.close()
        await interaction.edit_original_response(content="✅ Filas 3x3 Emulador criadas!")
    ...
    async def criar_filas_4x4_emu(self, interaction: discord.Interaction):
        ...
        for valor in VALORES_FILAS_1V1:
            ...
            conn.commit()
            conn.close()
        await interaction.edit_original_response(content="✅ Filas 4x4 Emulador criadas!")
    ...
    async def criar_filas_2x2_mob(self, interaction: discord.Interaction):
        ...
        for valor in VALORES_FILAS_1V1:
            ...
            conn.commit()
            conn.close()
        await interaction.edit_original_response(content="✅ Filas 2x2 Mobile criadas!")
    ...
    async def criar_filas_3x3_mob(self, interaction: discord.Interaction):
        ...
        for valor in VALORES_FILAS_1V1:
            ...
            conn.commit()
            conn.close()
        await interaction.edit_original_response(content="✅ Filas 3x3 Mobile criadas!")
    ...
    async def criar_filas_4x4_mob(self, interaction: discord.Interaction):
        ...
        for valor in VALORES_FILAS_1V1:
            ...
            conn.commit()
            conn.close()
        await interaction.edit_original_response(content="✅ Filas 4x4 Mobile criadas!")
    ...
    async def criar_filas_misto_2x2(self, interaction: discord.Interaction):
        ...
        for valor in VALORES_FILAS_1V1:
            ...
            conn.commit()
            conn.close()
        await interaction.edit_original_response(content="✅ Filas 2x2 Misto criadas!")
    ...
    async def criar_filas_misto_3x3(self, interaction: discord.Interaction):
        ...
        for valor in VALORES_FILAS_1V1:
            ...
            conn.commit()
            conn.close()
        await interaction.edit_original_response(content="✅ Filas 3x3 Misto criadas!")
    ...
    async def criar_filas_misto_4x4(self, interaction: discord.Interaction):
        ...
        for valor in VALORES_FILAS_1V1:
            ...
            conn.commit()
            conn.close()
        await interaction.edit_original_response(content="✅ Filas 4x4 Misto criadas!")
